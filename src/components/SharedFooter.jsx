        ...
        <footer className="bg-slate-950 dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen p-16 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="#" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-bold whitespace-nowrap text-gray-500 dark:text-white">Toy Land</span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">ToyLand™</a>. All Rights Reserved.
                    </span>
